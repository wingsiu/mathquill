...
Controller.open(function(_, super_) {
  ...
  _.writeLatex = function(latex) {
    ...
    //by alpha
      console.log("WriteLatex/block: ", block);
    //by alpha
    ...
    //by alpha
    console.log("writeLatex :",this , block);
    //by alpha
    return this;
  };
...
var Bracket = P(P(MathCommand, DelimsMixin), function(_, super_) {
  _.init = function(side, open, close, ctrlSeq, end) {
    ...
    //by alpha
//    this.sides[R] = { ch: '', ctrlSeq: '.' };
    console.log("bracket:", this);  
// by alpha
  };
  _.numBlocks = function() { return 1; };
  ...
  _.matchBrack = function(opts, expectedSide, node) {
    ...
    //by alpha
        console.log("matchBrack :", node, expectedSide, opts);
    //alpha
    return node instanceof Bracket && node.side && node.side !== -expectedSide
      && (!opts.restrictMismatchedBrackets
//by alpha
 //       || OPP_BRACKS[this.sides[this.side].ch] === node.sides[node.side].ch || node.sides[node.side].ch==''
...
//by alpha
  ...
  _.deleteSide = function(side, outward, cursor) {
    ...
    if (side === this.side) { // deleting non-ghost of one-sided bracket, unwrap
      this.unwrap();
//by alpha
        console.log("delete.side :", this);
//        if (side === L) {
//            this.sides[R].ch ='.';
//        }  else  this.sides[L].ch = '.';
//by alpha
...
LatexCmds.left = P(MathCommand, function(_) {
  _.parser = function() {
    ...
    var optWhitespace = Parser.optWhitespace;
     //by alpha 
    console.log("Command.left 1:", string);
  //alpha
    ...
    return optWhitespace.then(regex(/^(?:[([|]|\\\{|\\langle(?![a-zA-Z])|\\lVert(?![a-zA-Z]))/))
      .then(function(ctrlSeq) {
            //by alpha
                var self = this;
                console.log("Command.left 2:", ctrlSeq,self);
            //alpha
...
//          console.log("command/left/string", block);
...
//by alpha
 //          .then(regex(/^(?:[\])|]|\\\}|\\rangle(?![a-zA-Z])|\\rVert(?![a-zA-Z]))/)).map(function(end) {
              console.log("Command.left 3:end ",end);
...
//      return super_.parser.call(self);
//      self = this;
    console.log("latexCmds.right :", self);
//     self.ctrlSeq= '\\right.'
    return Parser.fail('unmatched \\right');
//by alpha
  };
